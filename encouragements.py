    ...
    if is_weekly:
        if streak >= 52:
            messages = [
                ...
                f"52 weeks of excellence! You're truly unstoppable!",
                f"One full year! You've made this habit a part of who you are!",
            ]
        elif streak >= 12:
            messages = [
                f"Three months strong - {streak} weeks of dedication!",
                f"A quarter year of consistency! Keep going!",
                f"{streak} weeks of commitment - you're building something great!",
            ]
        elif streak >= 4:
            messages = [
                f"One month milestone - {streak} fantastic weeks!",
                f"Four weeks of dedication! You're establishing a real routine!",
                f"A month of progress! This is becoming a true habit!",
            ]
        else:
            messages = [
