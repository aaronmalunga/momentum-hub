...
def main():
    ...
    if not habits:
        # First-time user: in demo mode we auto-create demo content without prompting.
        if args.demo:
            # Create demo habits, goals and also seed a small amount of history
            # so the demo shows analytics/streaks. This keeps demo setup simple
            # for reviewers and users who run `--demo`.
            try:
