...
def populate_test_db(db_name: str):
    ...
    # 5 predefined habits
    habits_data = [
        {"name": "Change beddings", "frequency": "weekly", "notes": "Wash and change beddings", "reminder_time": "09:00", "evening_reminder_time": None, "streak": 0, "is_active": True},
        {"name": "Code", "frequency": "daily", "notes": "Code for at least 1 hour", "reminder_time": "10:00", "evening_reminder_time": None, "streak": 0, "is_active": True},
        {"name": "Study", "frequency": "daily", "notes": "Review course materials", "reminder_time": "11:00", "evening_reminder_time": None, "streak": 0, "is_active": True},
        {"name": "Meditate", "frequency": "daily", "notes": "Meditate for at least 10 minutes", "reminder_time": "07:00", "evening_reminder_time": None, "streak": 0, "is_active": True},
        {"name": "Blog", "frequency": "weekly", "notes": "Write a Data Science blog post", "reminder_time": "11:00", "evening_reminder_time": None, "streak": 0, "is_active": True}
    ]    
    ...
    for data in habits_data:
        ...
        new_habit.id = habit_id # Assign the ID returned from the database to the habit instance
    ...
    today = datetime.datetime.now()    ### --> Making "Change beddings" with both streak and completion rate tests
    change_beddings_id = habit_ids["Change beddings"]
    change_beddings_habit_obj = next(h for h in created_habits if h.name == "Change beddings")
