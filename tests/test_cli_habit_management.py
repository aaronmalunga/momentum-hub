...
class TestCreateNewHabit:
    ...
    def test_create_new_habit_success(self, mock_press, mock_show, mock_get_cat, mock_update, mock_get_cats, mock_add, mock_select, mock_text):
        # Mock inputs
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_create_new_habit_cancel_frequency(self, mock_press, mock_show, mock_select, mock_text):
        mock_text.side_effect = [
            MagicMock(ask=MagicMock(return_value='Test Habit')),
            MagicMock(ask=MagicMock(return_value='Some notes'))
        ]
...
class TestMarkHabitCompleted:
    ...
    def test_mark_habit_completed_success(self, mock_enc, mock_press, mock_show, mock_get_habit, mock_update_streak, mock_update_habit, mock_add_comp, mock_select, mock_get_habits):
        habit = MagicMock()
        habit.id = 1
        ...
        mock_show.assert_any_call("'Test Habit' marked as completed! Current streak: 7", color='\x1b[32m', style='\x1b[1m')

    @patch('cli_habit_management.db.get_all_habits')
    @patch('cli_habit_management._handle_habit_selection')
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_mark_habit_completed_no_habits(self, mock_press, mock_show, mock_select, mock_get_habits):
...
class TestDeleteHabit:
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_delete_habit_success(self, mock_press, mock_show, mock_delete, mock_confirm, mock_select, mock_get_habits):
        habit = MagicMock()
        habit.id = 1
        habit.name = 'Test Habit'
        mock_get_habits.return_value = [habit]
        ...
        mock_show.assert_any_call("Habit 'Test Habit' deleted (deactivated) successfully!", color='\x1b[32m')
    ...
    def test_delete_habit_no_habits(self, mock_press, mock_show, mock_get_habits):
        ...
        mock_show.assert_called_with("No active habits found to delete.", color='\x1b[31m')
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_delete_habit_cancel_confirm(self, mock_press, mock_show, mock_confirm, mock_select, mock_get_habits):
...
class TestReactivateHabit:
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_reactivate_habit_success(self, mock_press, mock_show, mock_reactivate, mock_select, mock_get_habits):
        habit = MagicMock()
        habit.id = 1
        habit.name = 'Test Habit'
        habit.frequency = 'daily'
        ...
        mock_get_habits.return_value = [habit]
        mock_select.return_value = MagicMock(ask=MagicMock(return_value='1. Test Habit (daily)'))

        reactivate_habit('test.db')

        mock_reactivate.assert_called_once_with(1, 'test.db')
        mock_show.assert_any_call("Habit 'Test Habit' reactivated successfully!", color='\x1b[32m')

    @patch('cli_habit_management.db.get_all_habits')
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_reactivate_habit_no_deleted_habits(self, mock_press, mock_show, mock_get_habits):
        mock_get_habits.return_value = []

        reactivate_habit('test.db')

        mock_show.assert_called_with("No deleted habits found to reactivate.", color='\x1b[31m')

    @patch('cli_habit_management.db.get_all_habits')
    @patch('cli_habit_management.questionary.select')
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_reactivate_habit_cancel(self, mock_press, mock_show, mock_select, mock_get_habits):
...
class TestUpdateHabit:
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_update_habit_success(self, mock_press, mock_show, mock_update, mock_get_cat, mock_get_cats, mock_select, mock_text, mock_handle, mock_get_habits):
        habit = MagicMock(id=1, name='Old Name', frequency='daily', notes='Old notes', reminder_time='07:00', evening_reminder_time='19:00', category_id=None)
        mock_get_habits.return_value = [habit]
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_update_habit_no_habits(self, mock_press, mock_show, mock_handle, mock_get_habits):
        mock_get_habits.return_value = []
    ...
    @patch('cli_habit_management.show_colored_message')
    @patch('cli_habit_management.press_enter_to_continue')
    def test_update_habit_cancel_name(self, mock_press, mock_show, mock_text, mock_handle, mock_get_habits):
        habit = MagicMock(id=1, name='Test Habit')
        mock_get_habits.return_value = [habit]
        mock_handle.return_value = habit
        mock_text.return_value = MagicMock(ask=MagicMock(return_value=None))
